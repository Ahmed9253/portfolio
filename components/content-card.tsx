...
export default function ContentCard({ href, title, category, excerpt, image, meta }: Props) {
  return (
    <article className="group overflow-hidden rounded-2xl sm:rounded-3xl border border-zinc-800 bg-zinc-900">
      <Link href={href} className="block aspect-[4/3] sm:aspect-[16/10] overflow-hidden">
      ...
      <div className="p-5 sm:p-7">
        ...
        <Link href={href} className="text-xl sm:text-2xl font-bold text-white transition hover:text-cyan-400">{title}</Link>
